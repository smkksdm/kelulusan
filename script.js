...
function findStudentByNik(nik) {
    return studentData.find(student => student.nik === nik);
}
    ...
    const html = `
        <div class="student-info">
            <div class="info-item">
                ...
                <div class="info-value">${formatNik(student.nik)}</div>
            </div>
            <div class="info-item">
